...
class ExchGwApiHuobi(RESTfulApiSocket):
    """
    ...
    def get_order_book_link(cls, instmt):
        ...
        return "https://api.huobi.pro/market/depth?symbol=%s&type=step0" % instmt.get_instmt_code()
    ...
    def parse_trade(cls, instmt, raw):
        ...
        if cls.get_trades_timestamp_field_name() in keys and \
           ...
           cls.get_trade_price_field_name() in keys and \
            ...
            # Trade side
            dirction = raw[cls.get_trade_side_field_name()]
            trade.trade_side = MarketDataBase.Side.SELL
            if dirction == "buy":
...
class ExchGwHuobi(ExchangeGateway):
    ...
    def __init__(self, db_clients):
        ...
        """
        ExchangeGateway.__init__(self, ExchGwApiHuobi(), db_clients)
