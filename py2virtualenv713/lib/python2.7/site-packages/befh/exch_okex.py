...
class ExchGwOkExWs(WebSocketApiClient):
    ...
    def parse_l2_depth(cls, instmt, raw):
        ...
        if cls.get_order_book_timestamp_field_name() in keys and \
           ...
           cls.get_asks_field_name() in keys:
            ...
            l2_depth.date_time = timestamp # calendar.timegm(datetime.utcnow().timetuple()) #datetime.utcfromtimestamp(timestamp).strftime("%Y%m%d %H:%M:%S.%f")
    ...
    def parse_trade(cls, instmt, raw):
        ...
        trade.trade_id = (trade_id + timestamp).encode("utf-8")
