...
'''
http://doc.coinone.co.kr/#api-Public-Orderbook
'''
...
import calendar
class ExchGwApiCoinone(RESTfulApiSocket):
    """
    ...
    def get_order_book_link(cls, instmt):
        ...
        return "https://api.coinone.co.kr/orderbook/?currency=%s" % instmt.get_instmt_code()

    @classmethod
    def get_trades_link(cls, instmt):
        return "https://api.coinone.co.kr/trades/?currency=%s&period=hour" % instmt.get_instmt_code()
    ...
    def parse_trade(cls, instmt, raw):
        ...
        if cls.get_trades_timestamp_field_name() in keys and \
           ...
           cls.get_trade_volume_field_name() in keys:
            ...
            # Trade side
            trade.trade_side = MarketDataBase.Side.BUY
            ...
            # Trade id
            trade_date_time_str = datetime.utcfromtimestamp(trade.date_time).strftime("%Y%m%d %H:%M:%S.%f")
            trade.trade_id = trade_date_time_str + '-P' + str(trade.trade_price) + '-V' + str(trade.trade_volume)
        else:
    ...
    def get_trades(cls, instmt):
        ...
        trades = []
        if 'completeOrders' in res.keys():
            res = res['completeOrders']
...
class ExchGwCoinone(ExchangeGateway):
    ...
    def __init__(self, db_clients):
        ...
        """
        ExchangeGateway.__init__(self, ExchGwApiCoinone(), db_clients)
