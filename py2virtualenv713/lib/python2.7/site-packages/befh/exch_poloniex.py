...
class ExchGwApiPoloniex(RESTfulApiSocket):
    ...
    def get_order_book_link(cls, instmt):
        return "https://poloniex.com/public?command=returnOrderBook&currencyPair=%s&depth=10" % instmt.get_instmt_code()
    ...
    def parse_trade(cls, instmt, raw):
        ...
        if cls.get_trades_timestamp_field_name() in keys and \
           ...
           cls.get_trade_volume_field_name() in keys:
            ...
            trade.date_time = calendar.timegm(date_time.timetuple()) #date_time.strftime("%Y%m%d %H:%M:%S.%f")
