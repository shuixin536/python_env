...
import calendar
class ExchGwApiKorbit(RESTfulApiSocket):
    """
    ...
    def get_order_book_link(cls, instmt):
        ...
        return "https://api.korbit.co.kr/v1/orderbook?currency_pair=%s" % instmt.get_instmt_code()

    @classmethod
    def get_trades_link(cls, instmt):
        return "https://api.korbit.co.kr/v1/transactions?currency_pair=%s" % \
    ...
    def parse_l2_depth(cls, instmt, raw):
        ...
        if cls.get_order_book_timestamp_field_name() in keys and \
            ...
            l2_depth.date_time = timestamp  # datetime.utcfromtimestamp(timestamp).strftime("%Y%m%d %H:%M:%S.%f")
            # Bids----我想要买，出的买价
            # 默认是从高到低排序，所以需要反转-----
            # 从低到高--->b[0]取出买价里面的更高价
            # b[0] > b[1] > b[2] > b[3] > b[4]
...
class ExchGwKorbit(ExchangeGateway):
    """
    Exchange gateway
    """
    def __init__(self, db_clients):
        ...
        """
        ExchangeGateway.__init__(self, ExchGwApiKorbit(), db_clients)
